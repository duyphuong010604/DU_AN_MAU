      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí bình luận /</span> Danh sách bình luận</h4>
              ...
              <div class="table-responsive text-nowrap p-1">
                <table id="example" class="table mb-3">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?=$row['id_bl']?></strong></td>
                      <td><?=$row['noidung_bl']?></td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="chitiet_binhluan.php?id_bl=<?=$row['id_bl']?>"><i class='bx bx-detail me-1'></i>Chi tiết</a>
                            <a class="dropdown-item" href="sua_binhluan.php?id_bl=<?=$row['id_bl']?>"><i class="bx bx-edit-alt me-1"></i>Chỉnh sửa</a>
                            <a class="dropdown-item" href="../backend/binhluan-xoa.php?id_bl=<?=$row['id_bl']?>" ><i class="bx bx-trash me-1"></i> Xóa</a>
                          </div>
                        </div>
                      </td>
                    </tr>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Xóa bình luận</h5>
                              ...
                              <div class="card-body">
                                <div class="mb-3 col-12 mb-0">
                                  <div class="alert alert-warning">
                                    <h6 class="alert-heading fw-bold mb-1">Bạn chắc chăn muốn xóa bình luận?</h6>
                                    <p class="mb-0">Sau khi xóa không thể đặt ID đã tồn tại trong csdl.</p>
                                  </div>
                                </div>
                                  <form id="formAccountDeactivation" >
                                    <div class="form-check mb-3">
                                      ...
                                      <label class="form-check-label" for="accountActivation"
                                        >Tôi đồng ý xóa bình luận!</label
                                      >
                                    </div>
                                    <button type="submit" class="btn btn-danger deactivate-account">Xóa bình luận</button>
                                  </form>
                            </div>
                            </div>
                          </div>

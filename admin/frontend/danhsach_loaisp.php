                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="chitiet_loaisp.php"
                                ><i class='bx bx-detail me-1'></i>Chi tiết</a
                              >
                              <a class="dropdown-item" href="sua_loaisp.php"
                                ><i class="bx bx-edit-alt me-1"></i>Sửa</a
                              >
                              <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#exampleModal-xoalsp"
                                  ...
                                  <form id="formAccountDeactivation" >
                                    <div class="form-check mb-3">
                                      ...
                                      <label class="form-check-label" for="accountActivation"
                                        >Tôi đồng ý xóa loại sản phẩm!</label
                                      >
                                    </div>
                                    <button type="submit" class="btn btn-danger deactivate-account">Xóa loại sản phẩm</button>
                                  </form>
                            </div>
                            </div>
                          </div>

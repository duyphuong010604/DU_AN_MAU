                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Họ và tên</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Địa chỉ</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-phone">Số điện thoại</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">

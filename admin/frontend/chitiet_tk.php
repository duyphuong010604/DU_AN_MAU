      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí tài khoản người dùng / Danh sách quản lí tài khoản người dùng </span>/ Thông tin chi tiết tài khoản</h4>
            ...
            <div class="card-body">
              ...
              <form id="formAccountDeactivation">
                <div class="form-check mb-3">
                  ...
                  <label class="form-check-label" for="accountActivation">Tôi đồng ý xóa tài khoản!</label>
                </div>

        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí sản phẩm / Thêm mới sản phẩm  </span>/ Sửa sản phẩm</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="username_sp">Tên sản phẩm</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="hinhanh_sp">Hình ảnh</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="hinhanh_sp">Giá</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="hinhanh_sp" class="input-group-text"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="kichthuoc_sp">Kích thước</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="kichthuoc_sp" class="input-group-text"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="mota_sp">Mô tả</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="mota_sp" class="input-group-text"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="ngaynhap_sp" class="input-group-text"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="trangthai_sp">Trạng thái</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="trangthai_sp" class="input-group-text"
                                ><i class='bx bx-list-ul'></i></span>
                              <select name="trangthai_sp" id="trangthai_sp" class="form-control form-select">

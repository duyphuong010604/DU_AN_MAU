        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Tìm kiếm sản phẩm</h4>

              <!-- Bootstrap Table with Header - Footer -->
              <div class="card">
                <h5 class="card-header">Danh sách sản phẩm tìm kiếm</h5>
                <div class="table-responsive text-nowrap p-1">
                  <table id="example" class="table mb-3">
                    ...
                    if(isset($_POST['timkiem'])):
                        $noidung_timkiem = $_POST['timkiem'];
                        $ketqua = $timkiem->timkiem_sanpham($noidung_timkiem);

                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Hình ảnh</td>
                        <td><img src="../content/assets/img/backgrounds/18.jpg" alt="Ảnh sản phẩm" width="60px" height="60px"></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Admin trả lời</td>
                        <td>............</td>
                      </tr>
                      <tr>
                        <td>Ngày bình luận</td>
                        <td>12/09/2023</td>
                      </tr>
                      <tr>
                        <td>Trạng thái</td>
                    ...
                    <tfoot class="table-border-bottom-0 bg-secondary opacity-75 text-white fw-bold">
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal-xoabl">
                                  ...
                                  <form id="formAccountDeactivation" >
                                    <div class="form-check mb-3">
                                      ...
                                      <label class="form-check-label" for="accountActivation"
                                        >Tôi đồng ý xóa bình luận sản phẩm!</label
                                      >
                                    </div>

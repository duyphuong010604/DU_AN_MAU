      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí tài khoản người dùng / Danh sách tài khoản người dùng </span>/ Sửa tài khoản người dùng</h4>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="../backend/khachhang-sua.php" method="post">
                      ...
                      $id_kh = $_GET["id_kh"];
                      $rows = $khachhang->getById($id_kh);
                     
                      ?>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id_kh">ID Khách hàng</label>
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            <span id="id_kh" class="input-group-text"><i class='bx bx-user' ></i></span>
                            <input type="text" class="form-control" id="id_kh" aria-describedby="id_kh" required readonly name="id_kh" value="<?=$rows['id_kh']?>" />
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="username" placeholder="Nhập tên đăng nhập" aria-describedby="username" name="username"  value="<?=$rows['username']?> " required readonly/>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="password" class="form-control" id="password" placeholder="Mật khẩu" name="password" value="<?=$rows['password']?>" required/>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="ho" placeholder="Họ và tên đệm" name="ho" value="<?=$rows['ho']?>" required/>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="ten" placeholder="Tên" name="ten" aria-describedby="ten" value="<?=$rows['ten']?>" required/>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="diachi" class="form-control" placeholder="ACME Inc." aria-label="ACME Inc." aria-describedby="diachi" name="diachi" value="<?=$rows['diachi']?>" required/>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="email" class="form-control" placeholder="email" aria-label="email" aria-describedby="email" name="email" value="<?=$rows['email']?>" required />
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <input type="number" minlength="10" maxlength="10" id="sdt" class="form-control phone-mask" placeholder="658 799 8941" aria-label="658 799 8941" aria-describedby="sdt" name="sdt" value="<?=$rows['sdt']?>" required/>
                          </div>
                        </div>
                      </div>
                      <!-- <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge">
                            ...
                            <select name="trangthai" id="trangthai" class="form-control form-select" required>
                              ...
                              <option class="form-control" value="Cho phép" <?php if ($rows['trangthai'] === "Cho phép") echo "selected"; ?>>Cho phép</option>
                              <option class="form-control" value="Chặn" <?php if ($rows['trangthai'] === "Chặn") echo "selected"; ?>>Chặn</option>
                            </select>
                          </div>
                        </div>
                      </div>

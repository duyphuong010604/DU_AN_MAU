  ...
  <div class="collapse" id="search">
    <div class="card card-body mb-3">
      <form action="timkiem.php" method="post">
        <input type="text" name="search" class="form-control" placeholder="Tìm kiếm sản phẩm &amp; enter">
      </form>
    </div>
  </div>
  <div class="container"><a class="navbar-brand d-inline-flex d-flex justify-content-center align-items-center"
      href="index.php"><img class="d-inline-block"
        src="assets/img/gallery/White & Black Minimalist Logo Distro Fashion.png" width="42px" height="42px"
        alt="logo" /><span class="text-1000 fs-0 fw-bold ms-2">Borcelle</span></a>
    <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse"
      data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false"
      aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
    <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item px-2"><a class="nav-link fw-medium active" aria-current="page" href="index.php">Trang
            chủ</a></li>
      ...
      <form class="d-flex"><a class="text-1000" href="#!">
          ...
          </svg></a><a class="text-1000" data-bs-toggle="collapse" href="#search" role="button" aria-expanded="false" aria-controls="collapseExample">
